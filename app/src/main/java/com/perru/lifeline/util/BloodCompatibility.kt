...
object BloodCompatibility {
    private val donorCanGiveTo: Map<BloodGroup, Set<BloodGroup>> = mapOf(
        ...
        BloodGroup.O_POS to setOf(BloodGroup.O_POS, BloodGroup.A_POS, BloodGroup.B_POS, BloodGroup.AB_POS),
        BloodGroup.A_NEG to setOf(BloodGroup.A_NEG, BloodGroup.A_POS, BloodGroup.AB_NEG, BloodGroup.AB_POS),
        BloodGroup.A_POS to setOf(BloodGroup.A_POS, BloodGroup.AB_POS),
        BloodGroup.B_NEG to setOf(BloodGroup.B_NEG, BloodGroup.B_POS, BloodGroup.AB_NEG, BloodGroup.AB_POS),
        ...
        BloodGroup.AB_POS to setOf(BloodGroup.AB_POS)
    )
